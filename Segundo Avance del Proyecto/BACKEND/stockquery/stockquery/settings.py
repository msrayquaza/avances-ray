"""
Django settings for stockquery project.
...
SECRET_KEY = 'django-insecure-hr^847*hl3@#4y53r1^feml=x4_)(61!c4($p#%=0i-$k=e01#'
...
WSGI_APPLICATION = 'stockquery.wsgi.application'
